CREATE DATABASE IF NOT EXISTS okh;
USE okh;

CREATE USER IF NOT EXISTS 'admin'@'%' IDENTIFIED BY '#1pass';
GRANT ALL PRIVILEGES ON okh.* TO 'admin'@'%';

CREATE USER IF NOT EXISTS 'end_user'@'%' IDENTIFIED BY '#1pass';
GRANT SELECT, INSERT, UPDATE, DELETE ON okh.* TO 'end_user'@'%';
